...
module {
  func.func @CommuteCNot_Z_test() {
    ...
    %q2_1 = quantum.custom "RZ"(%cst_0) %q2 : !quantum.bit
    %q1_2 = quantum.custom "PauliZ"() %q0 : !quantum.bit

    // CHECK: %out_qubits_1 = quantum.custom "PauliZ"() %1 : !quantum.bit
    // CHECK: %out_qubits_2:2 = quantum.custom "CNOT"() %1, %2 : !quantum.bit, !quantum.bit
    ...
    // Measurement (Z-basis over full register)
