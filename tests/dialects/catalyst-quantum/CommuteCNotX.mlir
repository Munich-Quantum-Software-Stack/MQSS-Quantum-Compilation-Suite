...
module @kernel_CommuteCNOTX {
  func.func public @jit_kernel_CommuteCNOTX() -> (tensor<4xi64>, tensor<4xi64>) attributes {llvm.emit_c_interface} {
    %0:2 = call @kernel_CommuteCNOTX_0() : () -> (tensor<4xi64>, tensor<4xi64>)
    return %0#0, %0#1 : tensor<4xi64>, tensor<4xi64>
  }
  func.func public @kernel_CommuteCNOTX_0() -> (tensor<4xi64>, tensor<4xi64>) attributes {diff_method = "parameter-shift", llvm.linkage = #llvm.linkage<internal>, qnode} {
...
// CHECK: %out_qubits_2 = quantum.custom "PauliX"() %out_qubits_1#0 : !quantum.bit
