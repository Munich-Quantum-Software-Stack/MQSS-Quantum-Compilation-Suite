...
module @circuit_CommuteCNOTRx {
  ...
  func.func public @circuit_CommuteCNOTRx_0() -> (tensor<8xi64>, tensor<8xi64>) attributes {diff_method = "parameter-shift", llvm.linkage = #llvm.linkage<internal>, qnode} {
    ...
    %out_qubits_2:2 = quantum.custom "CNOT"() %2, %3 : !quantum.bit, !quantum.bit
    %out_qubits_3 = quantum.custom "RX"(%cst) %out_qubits_2#1 : !quantum.bit
    %out_qubits_4:2 = quantum.custom "CNOT"() %out_qubits_3, %out_qubits_2#0 : !quantum.bit, !quantum.bit
    %out_qubits_5 = quantum.custom "RX"(%cst_0) %out_qubits_4#0 : !quantum.bit
    %out_qubits_6:2 = quantum.custom "CNOT"() %out_qubits_4#1, %out_qubits_5 : !quantum.bit, !quantum.bit
    %out_qubits_7 = quantum.custom "PauliX"() %out_qubits_6#1 : !quantum.bit
    %out_qubits_8 = quantum.custom "RX"(%cst_1) %out_qubits_7 : !quantum.bit
    %4 = quantum.insert %0[ 0], %out_qubits_6#0 : !quantum.reg, !quantum.bit
    %5 = quantum.insert %4[ 1], %out_qubits_8 : !quantum.reg, !quantum.bit
...
// CHECK: %out_qubits_2 = quantum.custom "RX"(%cst) %3 : !quantum.bit
// CHECK: %out_qubits_3:2 = quantum.custom "CNOT"() %2, %out_qubits_2 : !quantum.bit, !quantum.bit
// CHECK: %out_qubits_4:2 = quantum.custom "CNOT"() %out_qubits_2, %out_qubits_3#0 : !quantum.bit, !quantum.bit
// CHECK: %out_qubits_5 = quantum.custom "RX"(%cst_0) %out_qubits_4#0 : !quantum.bit
