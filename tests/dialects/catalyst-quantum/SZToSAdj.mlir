...
module @circuit_SZToSAdj {
  func.func public @jit_circuit_SZToSAdj() -> (tensor<4xi64>, tensor<4xi64>) attributes {llvm.emit_c_interface} {
    %0:2 = call @circuit_SZToSAdj_0() : () -> (tensor<4xi64>, tensor<4xi64>)
    return %0#0, %0#1 : tensor<4xi64>, tensor<4xi64>
  }
  func.func public @circuit_SZToSAdj_0() -> (tensor<4xi64>, tensor<4xi64>) attributes {diff_method = "parameter-shift", llvm.linkage = #llvm.linkage<internal>, qnode} {
    ...
    %out_qubits_0 = quantum.custom "S"() %2 : !quantum.bit
...
// CHECK: %out_qubits_0 = quantum.custom "S"() %2 adj : !quantum.bit
// CHECK: %3 = quantum.insert %0[ 0], %out_qubits : !quantum.reg, !quantum.bit
// CHECK: %4 = quantum.insert %3[ 1], %out_qubits_0 : !quantum.reg, !quantum.bit