...
module @circuit_HXHToZ {
  func.func public @jit_circuit_HXHToZ() -> (tensor<4xi64>, tensor<4xi64>) attributes {llvm.emit_c_interface} {
    %0:2 = call @circuit_HXHToZ_0() : () -> (tensor<4xi64>, tensor<4xi64>)
    return %0#0, %0#1 : tensor<4xi64>, tensor<4xi64>
  }
  func.func public @circuit_HXHToZ_0() -> (tensor<4xi64>, tensor<4xi64>) attributes {diff_method = "parameter-shift", llvm.linkage = #llvm.linkage<internal>, qnode} {
    ...
    %out_qubits_0 = quantum.custom "PauliX"() %out_qubits : !quantum.bit
    %out_qubits_1 = quantum.custom "Hadamard"() %out_qubits_0 : !quantum.bit
    %2 = quantum.extract %0[ 1] : !quantum.reg -> !quantum.bit
    %out_qubits_2 = quantum.custom "Hadamard"() %2 : !quantum.bit
    %out_qubits_3:2 = quantum.custom "CNOT"() %out_qubits_1, %out_qubits_2 : !quantum.bit, !quantum.bit
