...
module @circuit_DoubleCNOTCancellation {
  func.func public @jit_circuit_DoubleCNOTCancellation() -> (tensor<4xi64>, tensor<4xi64>) attributes {llvm.emit_c_interface} {
    %0:2 = call @circuit_DoubleCNOTCancellation_0() : () -> (tensor<4xi64>, tensor<4xi64>)
    return %0#0, %0#1 : tensor<4xi64>, tensor<4xi64>
  }
  func.func public @circuit_DoubleCNOTCancellation_0() -> (tensor<4xi64>, tensor<4xi64>) attributes {diff_method = "parameter-shift", llvm.linkage = #llvm.linkage<internal>, qnode} {
    ...
    %out_qubits_1:2 = quantum.custom "CNOT"() %out_qubits_0#0, %out_qubits_0#1 : !quantum.bit, !quantum.bit
    ...
    %out_qubits_4:2 = quantum.custom "CNOT"() %out_qubits_3#0, %out_qubits_3#1 : !quantum.bit, !quantum.bit
    %out_qubits_5 = quantum.custom "PauliX"() %out_qubits_4#1 : !quantum.bit
    %out_qubits_6:2 = quantum.custom "CNOT"() %out_qubits_5, %out_qubits_4#0 : !quantum.bit, !quantum.bit
    %3 = quantum.insert %0[ 1], %out_qubits_6#0 : !quantum.reg, !quantum.bit
    %4 = quantum.insert %3[ 0], %out_qubits_6#1 : !quantum.reg, !quantum.bit
