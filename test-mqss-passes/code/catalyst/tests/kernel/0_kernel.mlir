module @kernel {
  func.func public @jit_kernel() -> (tensor<4xi64>, tensor<4xi64>) attributes {llvm.emit_c_interface} {
    %0:2 = catalyst.launch_kernel @module_kernel::@kernel() : () -> (tensor<4xi64>, tensor<4xi64>)
  ...
  module @module_kernel {
    ...
    func.func public @kernel() -> (tensor<4xi64>, tensor<4xi64>) attributes {diff_method = "parameter-shift", llvm.linkage = #llvm.linkage<internal>, qnode} {
      ...
      %6 = stablehlo.convert %eigvals : (tensor<4xf64>) -> tensor<4xi64>
      quantum.dealloc %4 : !quantum.reg
      quantum.device_release
      return %6, %counts : tensor<4xi64>, tensor<4xi64>
    }
  }
  func.func @setup() {
    quantum.init
